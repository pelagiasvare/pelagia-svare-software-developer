...
function Resume() {
  ...
  const handleDownloadPNG = async (e?: React.MouseEvent) => {
    ...
    try {
      // First attempt direct blob download of the high-res Pelagia-Svare-CV.png
      const response = await fetch("/Pelagia-Svare-CV.png");
      if (response.ok) {
        const blob = await response.blob();
        const blobUrl = window.URL.createObjectURL(blob);
        const link = document.createElement("a");
        link.href = blobUrl;
        link.download = "Pelagia-Svare-CV.png";
      ...
      // Fallback: render current DOM element to PNG
      ...
      console.error("Download failed, using direct anchor fallback:", err);
      const link = document.createElement("a");
      link.download = "Pelagia-Svare-CV.png";
      link.href = "/Pelagia-Svare-CV.png";
      document.body.appendChild(link);
      link.click();
      document.body.removeChild(link);
    } finally {
    ...
    <main className="w-full px-4 sm:px-8 pb-20 pt-4 max-w-5xl mx-auto print:p-0 print:m-0 print:max-w-none">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4 print:hidden">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <a
            href="/Pelagia-Svare-CV.png"
            download="Pelagia-Svare-CV.png"
            onClick={handleDownloadPNG}
            className="inline-flex items-center gap-1.5 rounded-lg bg-secondary px-5 py-2 text-sm font-bold text-secondary-foreground shadow-sm transition-opacity hover:opacity-90 cursor-pointer disabled:opacity-50"
          >
      ...
      {view === "web" ? (
        <article
          ref={resumeRef}
          className="w-full rounded-2xl border-2 border-border bg-card p-6 sm:p-10 shadow-[10px_10px_0_0_var(--color-secondary)] print:border-none print:shadow-none print:p-0"
        >
              ...
              <section>
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col">
                    <div className="flex items-baseline justify-between gap-2 flex-wrap">
                      ...
                      <span className="text-xs font-semibold text-muted-foreground">
                        Uncommon.org • 2026 - Present
                      </span>
                    </div>
                    <p className="mt-1.5 text-sm font-medium leading-relaxed text-foreground/90">
                      Contributed to development tasks and supported ongoing projects while teaching
                      coding to school students.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="mt-1.5 text-sm font-medium leading-relaxed text-foreground/90">
                      Teach Scratch programming, guide learners through coding projects and
                      computational thinking, and support creativity, problem-solving and digital
                      literacy.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="mt-1.5 text-sm font-medium leading-relaxed text-foreground/90">
                      Designed and built a mobile app connecting homeowners with trusted service
                      providers. Conducted user research, created wireframes and prototypes, defined
                      product features, and collaborated on development.
                    </p>
                  </div>
                </div>
              </section>
            ...
            <div className="lg:col-span-5 print:col-span-5 flex flex-col gap-8">
              ...
              <section>
                ...
                <ul className="flex flex-col gap-3 text-sm font-medium text-foreground/90 list-disc pl-5">
                  <li>
                    Built a home services platform connecting homeowners with trusted service
                    providers during Product Design training. Conducted user research, created
                    wireframes and prototypes, and designed user-friendly workflows.
                  </li>
                  <li>
                    Built a responsive portfolio website during Software Development training,
              ...
              <section>
                <div className="flex items-center gap-2 border-b-2 border-foreground pb-2 mb-4">
                  <CodeXml size={20} className="text-primary print:hidden" />
                  <h2 className="text-2xl font-bold tracking-tight uppercase text-foreground">
                    Core Skills
                  </h2>
                </div>
              ...
              <section>
                ...
                <div className="rounded-xl border border-border bg-card p-3 text-sm font-medium text-foreground shadow-sm">
                  ...
                  <p className="text-muted-foreground text-xs font-semibold mb-1">
                    Software Developer • Uncommon.org
                  </p>
          ...
          >
            ...
            >
              <p className="p-4 text-center text-sm">
                ...
                >
                  Click here to download Pelagia-Svare-CV.png
                </a>
              </p>
            </iframe>
          </object>
